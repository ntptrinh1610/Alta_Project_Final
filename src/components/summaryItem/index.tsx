  ...
  return (
    <div className={styles.summaryItem}>
      ...
      <div className={styles.summaryItemRight}>
        <h4 style={{ color: 'red', marginTop:'45px' }}>
          {props.value} <span style={{ }}>{props.icon}</span>
        </h4>
        <p className={styles.detailsp}>{props.title}</p>
        <div className={styles.details}>
          <p className={styles.detailsp}>
            <span className="dot textMenu" style={{ backgroundColor: props.color }}></span>
            Đang hoạt động: <strong>{props.active}</strong>
          </p>
          <p className={styles.detailsp}>
            <span className="dot textMenu" style={{ backgroundColor: "#999" }}></span>
